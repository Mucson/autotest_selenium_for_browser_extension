...
time.sleep(2)
# dfeed = driver.find_element_by_xpath("//div[@data-id='dfeed']").click()
dportal = driver.find_element_by_xpath("//div[@data-id='dportal']").click()
...
# "//div[@data-id='dfeed']"
# "//div[@data-id='dportal']"
# "//div[@data-id='dexplorer']"
# "//div[@data-id='info & help']"
